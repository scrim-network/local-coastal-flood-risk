...
lines(density(brickfd_rcp85$t_2060), col=BrBG[11], lwd=2)
lines(density(brickfd_rcp60$t_2060), col=BrBG[10], lwd=2)
lines(density(brickfd_rcp45$t_2060), col=BrBG[9], lwd=2)
lines(density(brickfd_rcp26$t_2060), col=BrBG[8], lwd=2)

lines(density(NO_fdft_rcp85$t_2060), col=PRGn[2], lwd=2)
lines(density(NO_fdft_rcp60$t_2060), col=PRGn[3], lwd=2)
lines(density(NO_fdft_rcp45$t_2060), col=PRGn[4], lwd=2)
lines(density(NO_fdft_rcp26$t_2060), col=PRGn[5], lwd=2)

lines(noaa2012$t_2060, rep(2.75, 4), col=BrBG[4:1], lwd=2, lty=3)
lines(usace2013$t_2060, rep(2.5, 3), col=RdBu[9:11], lwd=2, lty=3)
lines(carswg2016$t_2060, rep(2.25, 5), col=RdGy[7:11], lwd=2, lty=3)
lines(noaa2017$t_2060, rep(2, length(noaa2017$t_2060)), col=noaa_cols[8:2], lwd=1.5, lty=3)

points(noaa2012$t_2060, rep(2.75, 4), col=BrBG[4:1], pch=19)
points(usace2013$t_2060, rep(2.5, 3), col=RdBu[9:11], pch=19)
points(carswg2016$t_2060, rep(2.25, 5), col=RdGy[7:11], pch=19)
...
densbrickfd_rcp85_2060 <- density(brickfd_rcp85$t_2060)
densbrickfd_rcp60_2060 <- density(brickfd_rcp60$t_2060)
densbrickfd_rcp45_2060 <- density(brickfd_rcp45$t_2060)
densbrickfd_rcp26_2060 <- density(brickfd_rcp26$t_2060)
densNO_fd_rcp85_2060 <- density(NO_fdft_rcp85$t_2060)
densNO_fd_rcp60_2060 <- density(NO_fdft_rcp60$t_2060)
densNO_fd_rcp45_2060 <- density(NO_fdft_rcp45$t_2060)
densNO_fd_rcp26_2060 <- density(NO_fdft_rcp26$t_2060)
# 2100
...
lines(noaa2012$t_2060, rep(7.2, 4), col=trans_BrBG[4:1], lwd=1.5, lty=3)
lines(usace2013$t_2060, rep(6.7, 3), col=trans_RdBu[9:11], lwd=1.5, lty=3)
lines(carswg2016$t_2060, rep(6.2, 5), col=trans_RdGy[7:11], lwd=1.5, lty=3)
lines(noaa2017$t_2060, rep(5.7, length(noaa2017$t_2060)), col=trans_noaa_cols[8:2], lwd=1.5, lty=3)

points(noaa2012$t_2060, rep(7.2, 4), col=trans_BrBG[4:1], pch=20)
points(usace2013$t_2060, rep(6.7, 3), col=trans_RdBu[9:11], pch=20)
