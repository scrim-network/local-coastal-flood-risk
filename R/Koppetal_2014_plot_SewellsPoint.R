...
source("read_norfolk_sea_data.R")
...
plot(x=denskopp14_rcp85_2100$x, y=(denskopp14_rcp85_2100$y), xlab="Projected sea level: 2030-2100 (ft)", ylab="Probability density", yaxt="n", 
     main="",col=trans_RdGy[1], type="l", lwd=1.5, xlim = range(densNO_fd_rcp26_2050$x, denskopp14_rcp85_2100$x), ylim = c(0, 18.5), bty="l")
...
lines(x=denskopp14_rcp85_2060$x, y=(denskopp14_rcp85_2060$y+5), col=trans_RdGy[1], lwd=1.5)
lines(x=denskopp14_rcp60_2060$x, y=(denskopp14_rcp60_2060$y+5), col=trans_RdGy[2], lwd=1.5)
lines(x=denskopp14_rcp45_2060$x, y=(denskopp14_rcp45_2060$y+5), col=trans_RdGy[3], lwd=1.5)
lines(x=denskopp14_rcp26_2060$x, y=(denskopp14_rcp26_2060$y+5), col=trans_RdGy[4], lwd=1.5)

lines(x=densbrickfd_rcp85_2060$x, y=(densbrickfd_rcp85_2060$y+5), col=trans_BrBG[11], lwd=1.5)
lines(x=densbrickfd_rcp60_2060$x, y=(densbrickfd_rcp60_2060$y+5), col=trans_BrBG[10], lwd=1.5)
lines(x=densbrickfd_rcp45_2060$x, y=(densbrickfd_rcp45_2060$y+5), col=trans_BrBG[9], lwd=1.5)
lines(x=densbrickfd_rcp26_2060$x, y=(densbrickfd_rcp26_2060$y+5), col=trans_BrBG[8], lwd=1.5)

lines(x=densNO_fd_rcp85_2060$x, y=(densNO_fd_rcp85_2060$y+5), col=trans_PRGn[2], lwd=1.5)
lines(x=densNO_fd_rcp60_2060$x, y=(densNO_fd_rcp60_2060$y+5), col=trans_PRGn[3], lwd=1.5)
lines(x=densNO_fd_rcp45_2060$x, y=(densNO_fd_rcp45_2060$y+5), col=trans_PRGn[4], lwd=1.5)
lines(x=densNO_fd_rcp26_2060$x, y=(densNO_fd_rcp26_2060$y+5), col=trans_PRGn[5], lwd=1.5)
...
lines(x=denskopp14_rcp85_2050$x, y=(denskopp14_rcp85_2050$y+10.25), col=RdGy[1], lwd=1.5)
lines(x=denskopp14_rcp60_2050$x, y=(denskopp14_rcp60_2050$y+10.25), col=RdGy[2], lwd=1.5)
lines(x=denskopp14_rcp45_2050$x, y=(denskopp14_rcp45_2050$y+10.25), col=RdGy[3], lwd=1.5)
lines(x=denskopp14_rcp26_2050$x, y=(denskopp14_rcp26_2050$y+10.25), col=RdGy[4], lwd=1.5)

lines(x=densbrickfd_rcp85_2050$x, y=(densbrickfd_rcp85_2050$y+10.25), col=BrBG[11], lwd=1.5)
lines(x=densbrickfd_rcp60_2050$x, y=(densbrickfd_rcp60_2050$y+10.25), col=BrBG[10], lwd=1.5)
lines(x=densbrickfd_rcp45_2050$x, y=(densbrickfd_rcp45_2050$y+10.25), col=BrBG[9], lwd=1.5)
lines(x=densbrickfd_rcp26_2050$x, y=(densbrickfd_rcp26_2050$y+10.25), col=BrBG[8], lwd=1.5)

lines(x=densNO_fd_rcp85_2050$x, y=(densNO_fd_rcp85_2050$y+10.25), col=PRGn[2], lwd=1.5)
lines(x=densNO_fd_rcp60_2050$x, y=(densNO_fd_rcp60_2050$y+10.25), col=PRGn[3], lwd=1.5)
lines(x=densNO_fd_rcp45_2050$x, y=(densNO_fd_rcp45_2050$y+10.25), col=PRGn[4], lwd=1.5)
lines(x=densNO_fd_rcp26_2050$x, y=(densNO_fd_rcp26_2050$y+10.25), col=PRGn[5], lwd=1.5)
...
lines(x=denskopp14_rcp85_2030$x, y=(denskopp14_rcp85_2030$y+15), col=trans_RdGy[1], lwd=1.5)
lines(x=denskopp14_rcp60_2030$x, y=(denskopp14_rcp60_2030$y+15), col=trans_RdGy[2], lwd=1.5)
lines(x=denskopp14_rcp45_2030$x, y=(denskopp14_rcp45_2030$y+15), col=trans_RdGy[3], lwd=1.5)
lines(x=denskopp14_rcp26_2030$x, y=(denskopp14_rcp26_2030$y+15), col=trans_RdGy[4], lwd=1.5)

lines(x=densbrickfd_rcp85_2030$x, y=(densbrickfd_rcp85_2030$y+15), col=trans_BrBG[11], lwd=1.5)
lines(x=densbrickfd_rcp60_2030$x, y=(densbrickfd_rcp60_2030$y+15), col=trans_BrBG[10], lwd=1.5)
lines(x=densbrickfd_rcp45_2030$x, y=(densbrickfd_rcp45_2030$y+15), col=trans_BrBG[9], lwd=1.5)
lines(x=densbrickfd_rcp26_2030$x, y=(densbrickfd_rcp26_2030$y+15), col=trans_BrBG[8], lwd=1.5)

lines(x=densNO_fd_rcp85_2030$x, y=(densNO_fd_rcp85_2030$y+15), col=trans_PRGn[2], lwd=1.5)
lines(x=densNO_fd_rcp60_2030$x, y=(densNO_fd_rcp60_2030$y+15), col=trans_PRGn[3], lwd=1.5)
lines(x=densNO_fd_rcp45_2030$x, y=(densNO_fd_rcp45_2030$y+15), col=trans_PRGn[4], lwd=1.5)
lines(x=densNO_fd_rcp26_2030$x, y=(densNO_fd_rcp26_2030$y+15), col=trans_PRGn[5], lwd=1.5)
